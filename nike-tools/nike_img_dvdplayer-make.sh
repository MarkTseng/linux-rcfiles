...
# new audio fw
#cp ../image_file/components/AV_FW/System.map.audio_china_dtmb components/packages/package2/System.map.audio
#cp ../image_file/components/AV_FW/bluecore.audio.zip_china_dtmb components/packages/package2/bluecore.audio.zip
